...
var resizePizzas = function(size) { 
  ...
  function changePizzaSizes(size) {
    //moved these vars out of the loop no need
      var randP = document.getElementsByClassName('randomPizzaContainer');
      var dx = determineDx(randP[1], size);
      var newwidth = (randP[1].offsetWidth + dx) + 'px';
  	  var count = randP.length;
...
//took document.body.scrollTop out from inside the loop and assigned it to scrolTopvar
  var scrolTopVar = (document.body.scrollTop);
    //console.log("scrolTopVar"+scrolTopVar);
    var scrolTopdivVar = scrolTopVar/1250;
  for (var i = 0; i < len; i++) {
     var phase = Math.sin((scrolTopdivVar) + (i % 5));
